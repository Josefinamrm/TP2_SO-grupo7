...
void init(){
    ...
    // AVERIGUAR DIRECCION DE MEMORIA PARA PONER MEMORIA LIBRE 
    // iterar la lista y """poner la dirección de memoria"""
    
    // ASIGNAR EL free_mem
    free_mem = (Header *)FREE_MEM_START;
    free_mem->node.size = sizeof(Header);
